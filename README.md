...
Foi incluido um docker-composer para rodar o postgres com todas suas configuradas e com as informações da base de dados, sendo necessário apenas executá-lo para que a aplicação tenha aesso aos dados criados.
