...
Foi incluido um docker-composer e também um Dockerfile para rodar o postgres com todas as configuradas e as informações da base de dados. As instruções para rodar a aplicação com os diferentes arquivos estão na sessão "Como rodar".
