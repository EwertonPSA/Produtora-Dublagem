...
public class ViewSessaoDeGravacao extends JPanel {
	...
	public ViewSessaoDeGravacao() {
		...
		String[] mes_Abreviacoes_ComboBox = {"Jan" , "Fev" , "Mar" , "Abr" , "Mai" , "Jun" , "Jul" , "Ago" , "Set" , "Out" , "Nov" , "Dez"};
		...
		JLabel lblNewLabel = new JLabel("Sessões de Gravação");
		...
		btnNewButton = new JButton("Dados do Técnico");
