...
public class View {
	...
	private JFrame frmProdutoraDeAnime;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmProdutoraDeAnime.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmProdutoraDeAnime = new JFrame();
		frmProdutoraDeAnime.setTitle("Produtora de Anime");
		frmProdutoraDeAnime.setBounds(100, 100, 1100, 600);
		frmProdutoraDeAnime.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmProdutoraDeAnime.getContentPane().setLayout(new BorderLayout(0, 0));
		
		JSplitPane splitPane = new JSplitPane();
		frmProdutoraDeAnime.getContentPane().add(splitPane, BorderLayout.CENTER);
		...
		JButton buttonRegistrarGravacao = new JButton("Sessão de Gravação");
		...
		JButton btnSessoDeGravao = new JButton("Sessões de Gravação");
		...
		JButton btnTcnicoDeAudio = new JButton("Técnicos de Áudios");
